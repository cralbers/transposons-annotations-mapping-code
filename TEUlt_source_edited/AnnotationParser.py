...
import os
from AnnotationChecker import checkHelitronScanner, checkLtrHarvest, checkLtrPred, checkMiteFind, checkMiteTracker, checkMust, checkNCBICDD1000, checkRepeatModeler, checkRepeatMasker, checkSineFind, checkSineScan, checkTirVish, checkTransposonPSI, checkLtrRetriever
...
def parseAvailableResults(projectFolderPath):
    ...
    if(checkLtrRetriever(projectFolderPath)):
        pathResDir      = os.path.join(projectFolderPath,"ltrRetriever")
        fastaFile       = os.path.join(projectFolderPath,"sequence.fasta")
        targetGFFFile   = os.path.join(projectFolderPath,"parsedAnnotations","ltrRetriever.gff3")
        targetFastaFile = os.path.join(projectFolderPath,"parsedAnnotations","ltrRetriever.fasta")
        parseLtrRetriever(pathResDir, fastaFile, targetGFFFile, targetFastaFile)
